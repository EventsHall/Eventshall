...
<div class="container" style="background-color: black">
  <h2 class="blink" style="text-align:center; color:#1B7C7E;font-family: Times New Roman; background-color: black" ><b>Dev Palace</b></h2>
  <div class="row">
  <div class="col-lg-12">
...
<div class="container" id="table">
  ...
  <table class="table table-responsive"  >
    ...
    <tr>
      <th>Address:</th><td>228 EWS Gunjan Vihar Karrahi</td>
    </tr>
    <tr>
    ...
    <tr>
      <th>Website:</th><td><a href="#" style="text-decoration: none; color: red; background-color: black">www.landmarkhotel.com</a></td>
    </tr>
    <tr>
